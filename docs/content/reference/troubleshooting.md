...
Most of these come down to network reality or how tieba-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

tieba-cli rate-limits like any public site. tieba already paces
...
Where a surface is gated, tieba reads a cookie or token you supply
...
`tieba`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what tieba actually did
